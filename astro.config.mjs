...
export default defineConfig({
  // Canlı/kanonik adres — özel domain. canonical, OG, sitemap, JSON-LD hep bunu kullanır.
  // Domain değişirse SADECE burayı + public/robots.txt'i güncelle.
  site: 'https://erbaagenclikpansiyon.com',
